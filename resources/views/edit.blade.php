            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        @section('heading')
                            <h4 class="page-title">{{ trans('Module::module.edit_title') }}</h4>
                        @endsection
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                {{ Form::model($module, array('route' => array('module.update', $module->id), 'method' => 'PUT')) }}
                                ...
                                {{ Form::submit('Edit the Module!', array('class' => 'btn btn-primary')) }}
